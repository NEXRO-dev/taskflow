...
export default function Header() {
  ...
  return (
    <header 
      className="glass sticky top-0 z-50 px-6 py-4 border-b border-white/20"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between min-h-[64px]">
        ...
        {showMobileMenu && (
          <div
            ...
            className="absolute top-full left-0 right-0 bg-white/95 backdrop-blur-sm border-b border-white/20 p-4 sm:hidden"
          >
